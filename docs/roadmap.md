...
- [x] **Fase 5.0D — Modo Edição, Mutação e Concorrência Transacional.** Concluída sobre a baseline aprovada `2fc1eecf1073321de5a18ab3ba956c2e94ff6008`: toggle, criação, descarte confirmado, restauração condicionada e `$EDITOR` com `ReplaceBody`/`ClearBody`, no-op canônico e recovery literal. Prova real TUI ↔ desktop pelo harness isolado; 22 testes novos e os 21 anteriores preservados. Evidências e contagens em `docs/tui.md`, seção 11. Implementação `0ce2825262f28c40c8763f83b702a1368899dd37` com [CI verde](https://github.com/TheGhols/Note-it/actions/runs/34284207606). **5.0E não iniciada.**
