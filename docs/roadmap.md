...
- [ ] **Fase 5.0D.R0 — Fechamento do Contrato de Mutação Concorrente.** Implementação isolada do contrato: criação com publicação atômica condicionada à ausência, descarte/restauração condicionados por revision, ciclo de descarte compartilhado com o receiver desktop e protocolo privado v3. Fechamento condicionado aos gates e ao CI remoto. Detalhes e provas em `docs/tui.md`, seção 10. Não inicia a 5.0D funcional.
